export default function Button({ color = 'primary', size = 'base', text = '', href, handleClick, shrink = 1, iconArrow = false, iconMobile = true  }) {
  return (
    <button
    ...
    >
        ...
        { iconArrow && (
            <>
                {size == 'base' && (
                    <svg
                        width="20px" height="12px" viewBox="0 0 22 14" fill="none"
                ...
                {size == 'large' && (
                    <svg
                        width="26px" height="16px" viewBox="0 0 22 14" fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
                            d="M0.640137 7.15385H20.3324M20.3324 7.15385L13.8709 1M20.3324 7.15385L14.1786 13"
