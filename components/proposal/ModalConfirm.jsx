    ...
    >
        ...
        <div class="w-[calc(100%-48px)] h-auto max-w-[600px] rounded-xl shadow-xl bg-white absolute top-6 lg:top-16 left-1/2 transform translate-x-[-50%] p-6 lg:p-8 flex flex-col gap-y-6">
            <div class="flex items-start justify-between">
                ...
                <button onClick={() => setConfirmModal(false)} className="bg-white p-3 border border-gray-300 hover:bg-gray-200 transition rounded-full text-gray-900 flex items-center justify-center">
